...
const Hero = () => {
    return (
        <div className=" h-[calc(100vh-0px)] w-screen overflow-hidden ">
            <div className="absolute top-0 left-0 w-full h-full z-[-1] ">
                <div className="absolute top-0 left-0 w-full h-full z-10 bg-gradient-to-b from-transparent to-secondary"></div>
            ...
            <div className="flex w-full h-full md:pt-10 pt-36 items-center flex-col ">
                <div className="flex justify-center items-center">
                    <h1 className="text-black md:text-[150px] text-7xl font-bold font-Tangerine">Wrap Up</h1> 
                </div>
